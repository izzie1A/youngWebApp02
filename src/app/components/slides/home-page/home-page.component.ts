...
export class HomePageComponent {
  ...
  contactUsItemListZH = [];
  ourTeamTextEN = "We have over 40 experienced management and technical staff members at head office both financially and technically, we gain the advantage of fulfilling the diverse requirements of the developer, contractor, architect and designer.Our company would assign civil and structural engineers, architects, electrical and mechanical engineers, and technical staff to participate in our project whenever the situation requires.";
  ourTeamTextZH = "本公司現有行政及技術職員40多人，以雄厚實力及專業技術滿足各發展商，承辦商，建築師及設計師等的不同要求。如遇有技術要求較高的工程，本公司將因應需求而委派土木工程師，結構工程師，建築師或電機工程師作技術支援。";
  ourProjectTextEN = "Fuji (China) was incorporated in 1984 with its principal business in interior fitting-out and decoration services.In the past years, we have successfully completed hundreds of reputable projects including hotel, cub houses, restaurants, retail outlets, commercial premises and service apartment in Hong Kong, Macau and Mainland ChinaFuji (China) was awarded with ISO 9001 certificate in project management of interior decoration. The award for Fuji (China) registers the company's outstanding tradition in quality assurance and that our company has achieved an internationally recognized status for quality management standards.";
